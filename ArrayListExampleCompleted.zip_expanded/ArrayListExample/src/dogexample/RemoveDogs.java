 ...
 * When using a traditional for loop while removing items from an ArrayList, 
 * you must be careful that you
...
public class RemoveDogs {
	...
	public static void main(String[] args) {
		...
		for(int i=dogs.size()-1; i>=0; i--){
			Dog d = dogs.get(i);
			if(d.isRabiesVaccine()==true){
				Dog removedDog = dogs.remove(i);
			}
